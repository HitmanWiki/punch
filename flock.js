(() => {
    ...
    return o => {
        ...
        (n || void 0 === t) && (t = e.value, e.delta = n, e.rating = ((a, e) => a > e[1] ? "poor" : a > e[0] ? "needs-improvement" : "good")(e.value, i), a(e)))
    }
},
                o = a => {
...
// Fixed: proper closure of previous functions and separation
})());  // ← Close the previous IIFE
        (function() {
            const a = {
                    "Asia/Barnaul": "RU",
